...
int main()
{
    ...
    float (*map9)[maxMap][maxMap];
    float (*map17)[maxMap][maxMap];
    float (*map33)[maxMap][maxMap];

    float (*map5i)[maxMap][maxMap];
    float (*map9i)[maxMap][maxMap];
    float (*map17i)[maxMap][maxMap];
    float (*map33i)[maxMap][maxMap];

    map5 = ( float (*)[maxMap][maxMap]) gabor(2, 0.6, 1.25, 1.25);
    map9 = ( float (*)[maxMap][maxMap]) gabor(4, 0.44, 1.45, 1.45);
    map17 = ( float (*)[maxMap][maxMap]) gabor(8, 0.22, 2.7, 2.7);
    map33 = ( float (*)[maxMap][maxMap]) gabor(16, 0.12, 5.1, 5.1);

    map5i = ( float (*)[maxMap][maxMap]) gaborImajiner(2, 0.6, 1.25, 1.25);
    map9i = ( float (*)[maxMap][maxMap]) gaborImajiner(4, 0.44, 1.45, 1.45);
    map17i = ( float (*)[maxMap][maxMap]) gaborImajiner(8, 0.22, 2.7, 2.7);
    map33i = ( float (*)[maxMap][maxMap]) gaborImajiner(16, 0.12, 5.1, 5.1);
